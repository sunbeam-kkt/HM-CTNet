...
class Model(nn.Module):
    def __init__(self, num_class=60, num_point=25, num_person=2, graph=None, graph_args=dict(), in_channels=3,
        ...
        self.st_gcn_networks = nn.ModuleList((
            ...
            TCN_GCN_unit(base_channel, base_channel, A, adaptive=adaptive, **kwargs),
            TCN_GCN_unit(base_channel, base_channel, A, adaptive=adaptive, **kwargs),
            TCN_GCN_unit(base_channel, base_channel, A, adaptive=adaptive, **kwargs),
            TCN_GCN_unit(base_channel, base_channel*2, A, stride=2, adaptive=adaptive, **kwargs),
            TCN_GCN_unit(base_channel*2, base_channel*2, A, adaptive=adaptive, **kwargs),
            TCN_GCN_unit(base_channel*2, base_channel*2, A, adaptive=adaptive, **kwargs),
            TCN_GCN_unit(base_channel*2, base_channel*4, A, stride=2, adaptive=adaptive, **kwargs),
            TCN_GCN_unit(base_channel*4, base_channel*4, A, adaptive=adaptive, **kwargs),
            TCN_GCN_unit(base_channel*4, base_channel*4, A, adaptive=adaptive, **kwargs),
        ))
    ...
    def forward(self, x):
        ...
        # y = F.max_pool2d(x, x.size()[2:])
        # z = x + y
        # x = z.view(N, M, -1, 1, 1).mean(dim=1)
