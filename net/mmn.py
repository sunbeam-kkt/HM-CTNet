...
class Model(nn.Module):
    ...
    #def forward(self, x_rgb):
        ...
        predict, feature, OUTPUT = self.stgcn.extract_feature(x_)
        predict, feature, OUTPUT = predict.to(device), feature.to(device), OUTPUT.to(device)
        ...
        rgb_weighted = rgb_weighted.to(device)
