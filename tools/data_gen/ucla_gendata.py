...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--data_path', default='/data/xcl_data/3MNet-master/data/nucla/multiview_action_skeleton')
    parser.add_argument(
        '--ignored_sample_path',
        default='/home/xcl/3MNet-master/resource/NTU-RGB-D/samples_with_missing_skeletons.txt')
