#!/bin/bash
cd /home/xcl/MMNet-main/openpose/python/openpose

rgb_file_name_pre="/home/xcl/MMNet-main/data/ntu/nturgb+d_rgb/"
output_path_pre="/home/xcl/MMNet-main/openpose/python/openpose/"
sss=18
ccc=1
ppp=8
rrr=1
