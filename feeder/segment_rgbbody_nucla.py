...
frame_path = '/home/xcl/3MNet/NW_UCLA/multiview_action/'
openpose_path = '/data/xcl_data/MMNets/openpose_ucla/'
save_path = '/data/xcl_data/MMNets/ntu60/ntu_rgb_frames_crop/fivefs_ucla/'
debug = False
duplicate_list=[]
...
def cropBody(openpose_file, frame_file, action_id, flip):
    ...
    if len(skeleton['people']) == 1: # or action_id > 49:
        ...
        frame_concat=Image.new( 'RGB' , (96,192) , (0,0,0) )
        ...
        adjust_leg = 15
        # head = frame.crop((head_x-24, head_y - 24, head_x + 24, head_y + 24)) #2*3+1
        L_hand = frame.crop((L_hand_x-48, L_hand_y - 48 + adjust_hand, L_hand_x + 48, L_hand_y + 48 + adjust_hand))
        R_hand = frame.crop((R_hand_x-48, R_hand_y - 48 + adjust_hand, R_hand_x + 48, R_hand_y + 48 + adjust_hand))
...
def construct_st_roi(filename, evaluation=False, random_interval=False,random_roi_move=False,random_flip=False, temporal_rgb_frames=5):
    ...
    if os.path.isdir(frame_file):# and action_id == 50:
        ...
        fivefs_concat=Image.new( 'RGB' , (96*temporal_rgb_frames,192) , (0,0,0) )
        if_2_people = False
        i=0
                ...
                if not debug:
                    ...
                    while frame_croped == '':
                        ...
                        if os.path.isfile(openpose_file_) and os.path.isfile(frame_file_):
                            ...
                            if frame_croped == 2:
                                if_2_people = True
                                frame_croped = Image.new( 'RGB' , (96,192) , (0,0,0) )
                        else:
