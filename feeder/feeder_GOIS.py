...
#         self.rgb_path_ntu60 = '/data/xcl_data/MMNets/ntu60/ntu_rgb_frames_crop/twofs/'

#         self.load_data(mmap)
#         self.transform = transforms.Compose([
#             transforms.ToPILImage(),
#             #transforms.Resize(size=224),
#             transforms.Resize(size=(90,45*self.temporal_rgb_frames)),
...
#         rgb = np.array(rgb.getdata())                        # 从rgb中提取像素数据，并将其转换为Numpy数组，（0~255）
...
class Feeder(torch.utils.data.Dataset):
    ...
    def __init__(self,
        ...
        #self.rgb_path = '/mnt/nas/ntu-rgbd/NTU/RGB_videos/rgb_frames_all_rmbg/'
        self.rgb_path_ntu120 = '/media/bruce/2Tssd/data/ntu120/ntu_rgb_frames_crop/fivefs/'
        self.rgb_path_ntu60 = '/data/xcl_data/nturgb+d_rgb/nturgb+d_60_rgb/NTU60_RGB_MIS/'
